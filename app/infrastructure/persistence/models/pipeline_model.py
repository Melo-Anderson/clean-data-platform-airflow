...
class PipelineModel(Base, TimestampMixin):
    ...
    source_asset_name: Mapped[str] = mapped_column(String(255), nullable=False, default="")
    destination_asset_name: Mapped[str] = mapped_column(String(255), nullable=False, default="")
