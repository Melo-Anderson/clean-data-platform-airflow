...
def test_platform_client_get_latest_discovery_snapshot():
    ...
    mock_resp.json.return_value = {
        "object_name": "asset-platform-bronze.transactions",
        "fields": [
    ...
    with patch.object(client, "_get_client") as mock_get_client:
        ...
        assert snapshot["object_name"] == "asset-platform-bronze.transactions"
...
def test_submit_compute_job_passes_schema_snapshot_to_adapter():
    ...
    with patch(
        ...
        res = submit_compute_job(
            pipeline_id="p-123",
            source_objects=[{"object_name": "asset-platform-bronze.transactions"}],
